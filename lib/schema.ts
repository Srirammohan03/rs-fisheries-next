...
export const joiningFormSchema = z.object({
  ...
  uanNo: z.string().regex(NUMERIC_ONLY, "UAN must be numeric").optional(),

  esicNo: z.string().regex(NUMERIC_ONLY, "ESIC must be numeric").optional(),

  nomineeNameRelation: z.string().optional(),
